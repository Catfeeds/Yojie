...
<head>
    ...
    <title><?php echo C("COPYRIGHT");?></title>
...
<body id="pagebody" <?php if((Cookie::get('remember') == 1)): ?>onLoad="document.login.verify.focus();" <?php else: ?>onLoad="document.login.account.focus()"<?php endif; ?> >

<div class="login_header_lay" style="height: 94px;width: 100%;background: #fff;padding: 0;">

    <div class="login_header">

        <a class="login_logo left" href="/">

            <!--<img src="__PUBLIC__/Uploads/<?php echo ($logoPic); ?>" alt=""/>-->

           <img src="__PUBLIC__/Images/nydb.png" alt=""/>

             <!-- <span class="login_company_name">重庆市农业担保有限公司</span>
           -->
        </a>
...
<div class="login_main_lay">
    ...
    <!--焦点动画
    <div class="container">
    	<img src="tmlstyle/img/login/banner.jpg" width="100%">-->
       <!-- <div class="content">
            <ul class="pic login_banner_list">
                <li class="login_banner_one"></li>
                <li class="login_banner_two"></li>
                <li class="login_banner_three"></li>
            </ul>
        </div>-->
        <!--<div class="controll">-->
            <!--<div class="nav">-->
                <!--<ul class="nav_btn_group"></ul>-->
            <!--</div>-->
        <!--</div>-->
    </div><!--end 焦点动画-->
        ...
        <div class="login_box right">
            ...
            <form class="login_form" action="__URL__/signin/" method="post" name="login">
                ...
                <div class="login_group">
                    ...
                    <input id="password" type="password" autocomplete="off" name="password" placeholder="请输入您的登录密码" <?php if((Cookie::get('remember') == 1)): ?>value="<?php echo ($_COOKIE['userinfo']['pwd']); ?>"<?php endif; ?>/>
                ...
                <div class="login_fun">
                        ...
                        <span class="left" id="ssl">
                            ...
                            <input id="remember_password" name="remember" value="1" class="remember_password left" type="checkbox" <?php if((Cookie::get('remember') == 1)): ?>checked="checked"<?php endif; ?>/>
                ...
                <div class="return_info_lay"><?php if($info): ?><span class="return_info"><span class="icon-comments mr5"></span><?php echo ($info); ?></span><?php endif; ?></div>
...
<div class="login_footer_lay">
    ...
    <p>&copy;2015 <?php echo C('COPYRIGHT');?> All rights reserved ~ 渝ICP证201544944号</p>
