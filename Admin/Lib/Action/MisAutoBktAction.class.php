 ...
 * @version V1.0
*/
class MisAutoBktAction extends MisAutoBktExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_sauku','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_sauku','orderno',$this->getActionName(),1);
