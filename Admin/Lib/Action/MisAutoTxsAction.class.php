 ...
 * @version V1.0
*/
class MisAutoTxsAction extends MisAutoTxsExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_stmgn','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_stmgn','orderno',$this->getActionName(),1);
