 ...
 * @version V1.0
*/
class MisAutoMzuAction extends MisAutoMzuExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_cdzws','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_cdzws','orderno',$this->getActionName(),1);
