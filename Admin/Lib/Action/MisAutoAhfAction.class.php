 ...
 * @version V1.0
*/
class MisAutoAhfAction extends MisAutoAhfExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_pzfuk','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_pzfuk','orderno',$this->getActionName(),1);
