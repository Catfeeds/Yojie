 ...
 * @version V1.0
*/
class MisAutoDesAction extends MisAutoDesExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_hrstt','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_hrstt','orderno',$this->getActionName(),1);
