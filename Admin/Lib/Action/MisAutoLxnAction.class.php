 ...
 * @version V1.0
*/
class MisAutoLxnAction extends MisAutoLxnExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_oxqxg','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_oxqxg','orderno',$this->getActionName(),1);
