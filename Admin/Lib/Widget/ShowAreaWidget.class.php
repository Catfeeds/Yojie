		...
		$html=<<<EOF
			 ...
			 <div class="address_elm left">
			 	...
			 	<div style="width:100%;float:left;">
			 	    <input style="width:calc(100% - 6px);border-radius:4px 0 0 4px;" name="areainfo[{$fieldName}][detail]" value="{$detail}" id="address_detail_address_{$fieldName}" class="js-getLnglat area_push detail split_address input_new left {$required}"  placeholder="地址显示：省、市、区县、详细地址" type="text"  />
