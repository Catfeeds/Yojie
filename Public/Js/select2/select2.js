!function (e) {
    ...
    if (window.Select2 === t) {
        ...
        }, _ = "<div class='select2-measure-scrollbar'></div>", j = {
            "Ⓐ": "A",
            "Ａ": "A",
            "À": "A",
            "Á": "A",
        ...
        L = e(document), H = function () {
            ...
            bind: function (e) {
                ...
                this.opts = s = this.prepareOpts(s), this.id = s.id, 1 == this.opts.element.find("option[value='']").length && (this.opts.placeholder = this.opts.element.find("option[value='']").text()), s.element.data("select2") !== t && null !== s.element.data("select2") && s.element.data("select2").destroy(), this.container = this.createContainer(), this.liveRegion = e(".select2-hidden-accessible"), 0 == this.liveRegion.length && (this.liveRegion = e("<span>", {
                    role: "status",
                    "aria-live": "polite"
                ...
                if (i = s.element, "select" === i.get(0).tagName.toLowerCase() && (this.select = n = s.element), n && e.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function () {
                    ...
                    populateResults: function (i, n, o) {
                        var a, r = this.opts.id, c = this.liveRegion, h = 1, u = this.opts.element.val(),
                            d = i.parent().find(".select2-page");
                        (a = function (i, n, h, u, d, p, f) {
                            var g, m, v, b, w, C, S, y, x, E, d = n.parent().find(".select2-page");
                            i = s.sortResults(i, n, o);
                            var T = [], O = 20, P = i.length / O, I = -1;
                            if (g = 0, m = i.length, /^[1-9]+[0-9]*]*$/.test(P) || (P = Math.ceil(P)), d && d.find("div").remove(), P > 1) {
                                if (u > 0 && (g = (u - 1) * O, m > u * O && (m = u * O)), 0 == f) {
                                    if ("" != p && p != t) for (var k = 0; k < i.length; k++) p == i[k].id && (I = k);
                                    if (-1 != I) {
                                        for (; !(I >= g && m > I);) {
                                            if (g += O, !(m + O < i.length)) {
                                                m = i.length;
                                        ...
                                        1 == u && (u = Math.ceil((I + 1) / O))
                                    }
                                }
                                var A = '<div class="select_page_lay">';
                                A += '<span class="info">' + (g + 1) + "-" + m + "/" + i.length + "</span>", A += 1 == u ? '<span class="select2_page_end select2_page_left_end">&#171</span>' : '<a title="上一页" class="select2_page_prev" href="javascript:void(0)">&#171</a>', A += '<a class="select2_page" href="javascript:void(0)"><span class="current">' + u + "</span></a>", A += u == P ? '<span class="select2_page_end select2_page_right_end">&#187</span>' : '<a title="下一页" class="select2_page_next" href="javascript:void(0)">&#187</a>', A += "</div>", d.append(A), d.find("a.select2_page_prev").bind("click", function () {
                                    var e = n.parent().find(".select2-page"),
                                        t = parseInt(e.find(".current").html()) - 1;
                                    t > 1 && e.find(".current").html(t), a(i, n, 0, t, e, p, 1)
                                }), d.find("a.select2_page_next").bind("click", function () {
                                    var e = n.parent().find(".select2-page"),
                                        t = parseInt(e.find(".current").html()) + 1;
                                    t > 1 && e.find(".current").html(t), a(i, n, 0, t, e, p, 1)
                                })
                            }
                            for (g; m > g; g += 1) v = i[g], w = v.disabled === !0, b = !w && r(v) !== t, C = v.children && v.children.length > 0, S = e("<li></li>"), S.addClass("select2-results-dept-" + h), S.addClass("select2-result"), S.addClass(b ? "select2-result-selectable" : "select2-result-unselectable"), w && S.addClass("select2-disabled"), C && S.addClass("select2-result-with-children"), S.addClass(l.opts.formatResultCssClass(v)), S.attr("role", "presentation"), y = e(document.createElement("div")), y.addClass("select2-result-label"), y.attr("id", "select2-result-label-" + H()), y.attr("role", "option"), E = s.formatResult(v, y, o, l.opts.escapeMarkup), E !== t && (y.html(E), S.append(y)), C && (x = e("<ul></ul>"), x.addClass("select2-result-sub"), a(v.children, x, h + 1, d, p, 0), S.append(x)), S.data("select2-data", v), T.push(S[0]);
                            n.find("li").remove(), n.append(T), c.text(s.formatMatches(i.length)), l.positionDropdown()
                        })(n, i, 0, h, d, u, 0)
                    }
            ...
            createContainer: function () {
                var t = e(document.createElement("div")).attr({"class": "select2-container"}).html(["<a href='javascript:void(0)' class='select2-choice' tabindex='-1'>", "   <span class='select2-chosen'>&#160;</span><abbr class='select2-search-choice-close'></abbr>", "   <span class='select2-arrow' role='presentation'><b role='presentation'></b></span>", "</a>", "<label for='' class='select2-offscreen'></label>", "<input class='select2-focusser select2-offscreen' type='text' aria-haspopup='true' role='button' />", "<div class='select2-drop select2-display-none'>", "   <div class='select2-search'>", "       <label for='' class='select2-offscreen'></label>", "       <input type='text' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input' role='combobox' aria-expanded='true'", "       aria-autocomplete='list' />", "   </div>", "   <ul class='select2-results' role='listbox'>", "   </ul>", "<div class='select2-page'>", "</div>", "</div>"].join(""));
                return t
            }, enableInterface: function () {
                ...
                this.opts.element.attr("title", r || i.text()), this.focusser.attr("tabindex", this.elementTabIndex), this.search.attr("id", this.focusser.attr("id") + "_search"), this.search.prev().text(e("label[for='" + this.focusser.attr("id") + "']").text()).attr("for", this.search.attr("id")), this.search.on("keydown", this.bind(function (e) {
                    ...
                    if (this.isInterfaceEnabled() && e.which !== U.TAB && !U.isControl(e) && !U.isFunctionKey(e) && e.which !== U.ESC) {
                        ...
                        return e.which == U.DELETE || e.which == U.BACKSPACE ? ((this.opts.allowClear || 1 == this.opts.element.find("option[value='']").length) && this.clear(), void g(e)) : void 0
                    }
                ...
                this.selection.data("select2-data", e), n.empty(), null !== e && (s = this.opts.formatSelection(e, n, this.opts.escapeMarkup)), s !== t && n.append(s), i = this.opts.formatSelectionCssClass(e, n), i !== t && n.addClass(i), this.selection.removeClass("select2-default"), (this.opts.allowClear && this.getPlaceholder() !== t || 1 == this.opts.element.find("option[value='']").length) && this.container.addClass("select2-allowclear")
            }, val: function () {
                var e, s = !1, i = null, n = this, o = this.data();
                if (null != o && "" != o.id && (this.select.find("option").removeAttr("selected"), this.select.find('option[value="' + o.id + '"]').attr("selected", !0)), 0 === arguments.length) return this.opts.element.val();
            ...
            util: {debounce: u, markMatch: w, escapeMarkup: C, stripDiacritics: i},
