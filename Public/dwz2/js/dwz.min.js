...
//地址组件
    ...
    $("a.js-inputCheckMap",$p).on("click",function(){
        ...
        var inputsName=['province','city','area','address','longitude','latitude','formattedAddress'];
        var $inputs=inputsName.map(item=>`input[name="areainfoMap[areainfomap4][${item}]"]`).map(item=>$inputsParent.find(item));
        ...
        function mapInit(AMap,mapId,inputId){
                ...
                return new Promise((resolve,reject)=>{
                    ...
                    geocoder.getAddress(lnglat, function(status, result) {
                        if (status === 'complete'&&result.regeocode) {
                            ...
                            var street=address.township;
                            var detail=address.street+address.streetNumber;
                            //地图组件map承载结果
							map._result={province,city,district,street,detail,formattedAddress:result.regeocode.formattedAddress,lng:lnglat.N,lat:lnglat.O};
                            autoInput.value=province+city+district+detail;
            ...
            function lookup_address(map,$target){
                ...
                sure.addEventListener('click', function(){
					...
					$target['s_address'].val(result.detail);
                    ...
                    $target['address'].val(result.street);
...
$('.formBar button[type=submit]',$p).on('click',function(){
	...
	if($input_address.length>0){
        ...
        var longitude=inputs.find('input[name="areainfoMap[areainfomap4][longitude]"]');
        var latitude=inputs.find('input[name="areainfoMap[areainfomap4][latitude]"]');
